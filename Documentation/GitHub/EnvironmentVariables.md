...
| `NetworkMountainPort`          | `50051`        | (same)                     | Core   | gRPC port for Mountain RPC service                                                        | Mountain build.rs, Cocoon                |
| `NetworkCocoonPort`            | `50052`        | (same)                     | Core   | gRPC port for Cocoon RPC service                                                          | Mountain build.rs, Cocoon                |
