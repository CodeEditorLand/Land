...
Registry.as(WorkbenchExtensions.Workbench)
    .registerWorkbenchContribution(DirtyDiffWorkbenchController, 3);
...
viewsRegistry.registerViews([{
        ...
        openCommandActionDescriptor: {
            ...
            keybindings: {
                primary: 0,
                win: { primary: 2048 | 1024 | 37 },
                linux: { primary: 2048 | 1024 | 37 },
                mac: { primary: 256 | 1024 | 37 },
            },
            order: 2,
        }
    }], viewContainer);
viewsRegistry.registerViews([{
        ...
        weight: 40,
        order: 2,
        when: ContextKeyExpr.and(ContextKeyExpr.and(ContextKeyExpr.has('scm.providerCount'), ContextKeyExpr.notEquals('scm.providerCount', 0)), ContextKeyExpr.and(IsWebContext, RemoteNameContext.isEqualTo(''))?.negate()),
        containerIcon: sourceControlViewIcon
    }], viewContainer);
Registry.as(WorkbenchExtensions.Workbench)
    .registerWorkbenchContribution(SCMActiveRepositoryController, 3);
Registry.as(WorkbenchExtensions.Workbench)
    .registerWorkbenchContribution(SCMActiveResourceContextKeyController, 3);
registerWorkbenchContribution2(SCMWorkingSetController.ID, SCMWorkingSetController, 3);
...
registerSingleton(ISCMService, SCMService, 1);
registerSingleton(ISCMViewService, SCMViewService, 1);
registerSingleton(IQuickDiffService, QuickDiffService, 1);
