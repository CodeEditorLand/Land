...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    when: ContextKeyExpr.and(ActiveEditorAvailableEditorIdsContext, OpenEditorsGroupContext.toNegated())
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, ({
    ...
    when: ContextKeyExpr.and(IsWebContext, ExplorerFolderContext, ExplorerResourceNotReadonlyContext)
}));
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    group: '6_copypath',
    order: 10,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        precondition: ContextKeyExpr.or(ContextKeyExpr.and(ActiveEditorCanRevertContext), ContextKeyExpr.and(ResourceContextKey.Scheme.notEqualsTo(Schemas.untitled), FoldersViewVisibleContext, SidebarFocusContext)),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
