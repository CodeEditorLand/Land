...
export class RunToCursorAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            precondition: ContextKeyExpr.and(CONTEXT_DEBUGGERS_AVAILABLE, PanelFocusContext.toNegated(), ContextKeyExpr.or(EditorContextKeys.editorTextFocus, CONTEXT_DISASSEMBLY_VIEW_FOCUS), CONTEXT_IN_CHAT_SESSION.negate()),
            contextMenuOpts: {
                group: 'debug',
                order: 2,
...
export class SelectionToReplAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            precondition: ContextKeyExpr.and(CONTEXT_IN_DEBUG_MODE, EditorContextKeys.editorTextFocus, CONTEXT_IN_CHAT_SESSION.negate()),
            contextMenuOpts: {
                group: 'debug',
                order: 0
            }
