...
let BreakpointEditorContribution = class BreakpointEditorContribution {
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            ...
            actions.push(new Action('addTriggeredBreakpoint', nls.localize('addTriggeredBreakpoint', "Add Triggered Breakpoint..."), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, 3))));
        }
...
class InlineBreakpointWidget {
    ...
    create(cssClass) {
        ...
        this.toDispose.push(this.editor.onDidChangeConfiguration(c => {
            if (c.hasChanged(54) || c.hasChanged(69)) {
                updateSize();
            }
        }));
    }
