...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(OpenerValidatorContributions, 3);
...
registerSingleton(ITrustedDomainService, TrustedDomainService, 1);
