...
let ReplInputHintContentWidget = class ReplInputHintContentWidget extends Disposable {
    ...
    constructor(editor, configurationService, keybindingService) {
        ...
        this._register(onDidFocusEditorText(() => {
            if (this.editor.hasTextFocus() && this.ariaLabel && configurationService.getValue("accessibility.verbosity.replInputHint" /* AccessibilityVerbositySettingId.ReplInputHint */)) {
    ...
    setHint() {
        ...
        if (keybinding && keybindingHintLabel) {
            ...
            this.ariaLabel = helpInfo.concat(actionPart, localize('disableHint', ' Toggle {0} in settings to disable this hint.', "accessibility.verbosity.replInputHint" /* AccessibilityVerbositySettingId.ReplInputHint */));
        }
    }
    getKeybinding() {
