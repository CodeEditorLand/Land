...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(LogOutputChannels, 3);
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(LogLevelMigration, 4);
