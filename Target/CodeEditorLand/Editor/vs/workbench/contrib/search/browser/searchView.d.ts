...
import { FileMatchOrMatch, ISearchViewModelWorkbenchService, RenderableMatch, SearchModel, SearchResult } from './searchModel.js';
...
export declare class SearchView extends ViewPane {
    ...
    getControl(): WorkbenchCompressibleAsyncDataTree<SearchResult, RenderableMatch, void>;
...
export declare function getEditorSelectionFromMatch(element: FileMatchOrMatch, viewModel: SearchModel): import("../../../../editor/common/core/range.js").Range | {
