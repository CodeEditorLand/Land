...
export declare class FolderMatch extends Disposable {
    ...
    private _name;
    constructor(_resource: URI | null, _id: string, _index: number, _query: ITextQuery, _parent: TextSearchResult | FolderMatch, _searchResult: SearchResult, _closestRoot: FolderMatchWorkspaceRoot | null, replaceService: IReplaceService, instantiationService: IInstantiationService, labelService: ILabelService, uriIdentityService: IUriIdentityService);
...
export declare class FolderMatchWithResource extends FolderMatch {
    ...
    constructor(_resource: URI, _id: string, _index: number, _query: ITextQuery, _parent: TextSearchResult | FolderMatch, _searchResult: SearchResult, _closestRoot: FolderMatchWorkspaceRoot | null, replaceService: IReplaceService, instantiationService: IInstantiationService, labelService: ILabelService, uriIdentityService: IUriIdentityService);
    get resource(): URI;
...
export declare class FolderMatchWorkspaceRoot extends FolderMatchWithResource {
    ...
    constructor(_resource: URI, _id: string, _index: number, _query: ITextQuery, _parent: TextSearchResult, _ai: boolean, replaceService: IReplaceService, instantiationService: IInstantiationService, labelService: ILabelService, uriIdentityService: IUriIdentityService);
...
export declare class FolderMatchNoRoot extends FolderMatch {
    constructor(_id: string, _index: number, _query: ITextQuery, _parent: TextSearchResult, replaceService: IReplaceService, instantiationService: IInstantiationService, labelService: ILabelService, uriIdentityService: IUriIdentityService);
...
export declare class TextSearchResult extends Disposable {
    ...
    constructor(_allowOtherResults: boolean, _parent: SearchResult, _id: string, instantiationService: IInstantiationService, uriIdentityService: IUriIdentityService);
    hide(): void;
    ...
    name(): string;
    get isDirty(): boolean;
    getFolderMatch(resource: URI): FolderMatchWorkspaceRoot | FolderMatch | undefined;
...
export declare class ReplaceableTextSearchResult extends TextSearchResult {
    private readonly replaceService;
    constructor(_allowOtherResults: boolean, parent: SearchResult, id: string, instantiationService: IInstantiationService, uriIdentityService: IUriIdentityService, replaceService: IReplaceService);
    replace(match: FileMatch): Promise<any>;
...
export declare class SearchResult extends Disposable {
    ...
    constructor(searchModel: SearchModel, instantiationService: IInstantiationService, modelService: IModelService, notebookEditorService: INotebookEditorService);
