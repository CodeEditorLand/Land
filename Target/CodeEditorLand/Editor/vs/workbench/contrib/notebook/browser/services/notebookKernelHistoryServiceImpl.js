...
let NotebookKernelHistoryService = class NotebookKernelHistoryService extends Disposable {
    ...
    constructor(_storageService, _notebookKernelService, _notebookLoggingService) {
        ...
        this._register(this._storageService.onDidChangeValue(1 /* StorageScope.WORKSPACE */, NotebookKernelHistoryService_1.STORAGE_KEY, this._register(new DisposableStore()))(() => {
            this._loadState();
        }));
    }
    getKernels(notebook) {
