...
registerSingleton(INotebookService, NotebookService, 1);
registerSingleton(INotebookEditorWorkerService, NotebookEditorWorkerServiceImpl, 1);
registerSingleton(INotebookEditorModelResolverService, NotebookModelResolverServiceImpl, 1);
registerSingleton(INotebookCellStatusBarService, NotebookCellStatusBarService, 1);
registerSingleton(INotebookEditorService, NotebookEditorWidgetService, 1);
registerSingleton(INotebookKernelService, NotebookKernelService, 1);
registerSingleton(INotebookKernelHistoryService, NotebookKernelHistoryService, 1);
registerSingleton(INotebookExecutionService, NotebookExecutionService, 1);
registerSingleton(INotebookExecutionStateService, NotebookExecutionStateService, 1);
registerSingleton(INotebookRendererMessagingService, NotebookRendererMessagingService, 1);
registerSingleton(INotebookKeymapService, NotebookKeymapService, 1);
registerSingleton(INotebookLoggingService, NotebookLoggingService, 1);
registerSingleton(INotebookCellOutlineDataSourceFactory, NotebookCellOutlineDataSourceFactory, 1);
registerSingleton(INotebookOutlineEntryFactory, NotebookOutlineEntryFactory, 1);
const schemas = {};
