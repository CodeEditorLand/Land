        ...
        super({
            ...
            menu: [{
                ...
                },
                {
                    ...
                    when: ContextKeyExpr.and(accessibleViewIsShown, ContextKeyExpr.equals(accessibleViewCurrentProviderId.key, "comments")),
                }]
        });
    }
...
registerSingleton(ICommentService, CommentService, 1);
...
Registry.as(Extensions.Workbench).registerWorkbenchContribution(UnresolvedCommentsBadge, 4);
