...
let ReviewZoneWidget = class ReviewZoneWidget extends ZoneWidget {
    ...
    async display(range, shouldReveal) {
        ...
        await this._commentThreadWidget.display(this.editor.getOption(69 /* EditorOption.lineHeight */), shouldReveal);
    ...
    _refresh(dimensions) {
        ...
        if (this._isExpanded) {
            ...
            const headHeight = Math.ceil(this.editor.getOption(69 /* EditorOption.lineHeight */) * 1.2);
