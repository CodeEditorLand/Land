...
let InlineChatZoneWidget = class InlineChatZoneWidget extends ZoneWidget {
    ...
    _computeHeight() {
        ...
        const heightInLines = contentHeight / this.editor.getOption(69 /* EditorOption.lineHeight */);
    ...
    reveal(position) {
        const stickyScroll = this.editor.getOption(119 /* EditorOption.stickyScroll */);
