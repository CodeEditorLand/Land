    ...
    constructor() {
        super({
            ...
            menu: [{
                    ...
                    group: '0_main',
                    order: 1,
                    when: ContextKeyExpr.and(CONTEXT_CHAT_INPUT_HAS_TEXT.toNegated(), CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.toNegated(), CTX_INLINE_CHAT_RESPONSE_TYPE.isEqualTo("messagesAndEdits" /* InlineChatResponseType.MessagesAndEdits */)),
                }, {
    ...
    constructor() {
        super({
            ...
            menu: [{
                    ...
                    group: '0_main',
                    order: 2,
                    when: ContextKeyExpr.and(CONTEXT_CHAT_INPUT_HAS_TEXT.toNegated(), CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.negate(), CTX_INLINE_CHAT_RESPONSE_TYPE.isEqualTo("messagesAndEdits" /* InlineChatResponseType.MessagesAndEdits */), CTX_INLINE_CHAT_EDIT_MODE.isEqualTo("live" /* EditMode.Live */)),
                }, {
                    id: MENU_INLINE_CHAT_ZONE,
                    group: 'navigation',
                    order: 2
    ...
    constructor() {
        super({
            ...
            menu: {
                ...
                group: '0_main',
                order: 5,
                when: ContextKeyExpr.and(CONTEXT_CHAT_INPUT_HAS_TEXT.toNegated(), CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.negate(), CTX_INLINE_CHAT_RESPONSE_TYPE.notEqualsTo("none" /* InlineChatResponseType.None */))
            },
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
    ...
    constructor() {
        super({
            ...
            menu: [{
                    ...
                    group: '0_main',
                    order: 1,
                    when: ContextKeyExpr.and(CONTEXT_CHAT_INPUT_HAS_TEXT.toNegated(), CTX_INLINE_CHAT_RESPONSE_TYPE.isEqualTo("messages" /* InlineChatResponseType.Messages */), CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.negate())
                }],
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 2048 /* KeyMod.CtrlCmd */ | 18 /* KeyCode.DownArrow */,
