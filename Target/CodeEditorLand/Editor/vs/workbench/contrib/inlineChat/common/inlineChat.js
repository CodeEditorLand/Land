...
Registry.as(Extensions.Configuration).registerConfiguration({
    ...
    properties: {
        ...
        ["inlineChat.experimental.enableZoneToolbar"]: {
...
export const CTX_INLINE_CHAT_EDIT_MODE = new RawContextKey('config.inlineChat.mode', "live");
...
export const CTX_INLINE_CHAT_RESPONSE_TYPE = new RawContextKey('inlineChatResponseType', "none", localize('inlineChatResponseTypes', "What type was the responses have been receieved, nothing yet, just messages, or messaged and local edits"));
