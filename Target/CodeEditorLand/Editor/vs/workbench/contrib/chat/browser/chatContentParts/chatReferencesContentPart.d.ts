...
export declare class CollapsibleListPool extends Disposable {
    ...
    constructor(_onDidChangeVisibility: Event<boolean>, menuId: MenuId | undefined, options: {
        enableFileDecorations?: boolean;
    } | undefined, instantiationService: IInstantiationService, themeService: IThemeService, labelService: ILabelService);
    private listFactory;
