...
import { CHAT_EDITING_MULTI_DIFF_SOURCE_RESOLVER_SCHEME, chatEditingResourceContextKey, chatEditingWidgetFileStateContextKey, decidedChatEditingResourceContextKey, IChatEditingService, inChatEditingSessionContextKey } from '../common/chatEditingService.js';
    ...
    constructor() {
        super({
            ...
            menu: [{
                    ...
                    when: ContextKeyExpr.equals(chatEditingWidgetFileStateContextKey.key, 3 /* WorkingSetEntryState.Attached */),
                    order: 0,
                    group: 'navigation'
                }],
        });
