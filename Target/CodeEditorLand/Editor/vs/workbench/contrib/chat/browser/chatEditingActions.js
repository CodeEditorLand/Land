...
import { CHAT_EDITING_MULTI_DIFF_SOURCE_RESOLVER_SCHEME, chatEditingResourceContextKey, chatEditingWidgetFileStateContextKey, decidedChatEditingResourceContextKey, IChatEditingService, WorkingSetEntryState } from '../common/chatEditingService.js';
...
registerAction2(class RemoveFileFromWorkingSet extends WorkingSetAction {
    ...
    async runWorkingSetAction(accessor, currentEditingSession, chatWidget, ...uris) {
        ...
        chatWidget.getContrib(ChatContextAttachments.ID)?.setContext(true, ...newContext);
    }
});
