...
export class VoiceChatInChatViewAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            precondition: ContextKeyExpr.and(CanVoiceChat, CONTEXT_CHAT_REQUEST_IN_PROGRESS.negate() // disable when a chat request is in progress
            ),
            f1: true
        }, 'view');
    }
    ...
    constructor() {
        super({
            ...
            keybinding: {
                ...
                when: ContextKeyExpr.and(CanVoiceChat, CONTEXT_CHAT_REQUEST_IN_PROGRESS.negate(), // disable when a chat request is in progress
...
export class InlineVoiceChatAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            category: CHAT_CATEGORY,
            precondition: ContextKeyExpr.and(CanVoiceChat, ActiveEditorContext, CONTEXT_CHAT_REQUEST_IN_PROGRESS.negate() // disable when a chat request is in progress
            ),
            f1: true
        }, 'inline');
    }
        ...
        super({
            ...
            menu: [
                ...
                },
                {
                    ...
                    when: ContextKeyExpr.and(HasSpeechProvider, ScopedChatSynthesisInProgress.negate(), // hide when text to speech is in progress
                    AnyScopedVoiceChatInProgress?.negate()),
                    group: 'navigation',
                    order: -1
                },
    ...
    constructor() {
        super({
            ...
            menu: [{
                    ...
                    when: ContextKeyExpr.and(CanVoiceChat, CONTEXT_RESPONSE, // only for responses
