...
export const terminalSuggestConfiguration = {
    ["terminal.integrated.suggest.enabled"]: {
        restricted: true,
        markdownDescription: localize('suggest.enabled', "Enables experimental terminal Intellisense suggestions for supported shells ({0}) when {1} is set to {2}.\n\nIf shell integration is installed manually, {3} needs to be set to {4} before calling the shell integration script.", 'PowerShell v7+', `\`#${"terminal.integrated.shellIntegration.enabled"}#\``, '`true`', '`VSCODE_SUGGEST`', '`1`'),
        type: 'boolean',
        default: false,
    },
