...
export declare const defaultTerminalContribCommandsToSkipShell: (TerminalAccessibilityCommandId | import("../terminalContrib/find/common/terminal.find.js").TerminalFindCommandId | import("../terminalContrib/suggest/common/terminal.suggest.js").TerminalSuggestCommandId)[];
