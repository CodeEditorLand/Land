...
registerSingleton(ISignService, SignService, 1);
registerSingleton(IExtensionStoragePaths, ExtensionStoragePaths, 0);
registerSingleton(IExtHostDebugService, ExtHostDebugService, 0);
registerSingleton(IExtHostSearch, NativeExtHostSearch, 0);
registerSingleton(IExtHostTask, ExtHostTask, 0);
registerSingleton(IExtHostTerminalService, ExtHostTerminalService, 0);
registerSingleton(IExtHostTunnelService, NodeExtHostTunnelService, 0);
registerSingleton(IExtHostVariableResolverProvider, NodeExtHostVariableResolverProviderService, 0);
