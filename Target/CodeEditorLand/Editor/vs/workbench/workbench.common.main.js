...
registerSingleton(IUserDataSyncLogService, UserDataSyncLogService, 1);
registerSingleton(IIgnoredExtensionsManagementService, IgnoredExtensionsManagementService, 1);
registerSingleton(IGlobalExtensionEnablementService, GlobalExtensionEnablementService, 1);
registerSingleton(IExtensionStorageService, ExtensionStorageService, 1);
registerSingleton(IExtensionGalleryService, ExtensionGalleryService, 1);
registerSingleton(IContextViewService, ContextViewService, 1);
registerSingleton(IListService, ListService, 1);
registerSingleton(IEditorWorkerService, WorkbenchEditorWorkerService, 0);
registerSingleton(IMarkerDecorationsService, MarkerDecorationsService, 1);
registerSingleton(IMarkerService, MarkerService, 1);
registerSingleton(IContextKeyService, ContextKeyService, 1);
registerSingleton(ITextResourceConfigurationService, TextResourceConfigurationService, 1);
registerSingleton(IDownloadService, DownloadService, 1);
registerSingleton(IOpenerService, OpenerService, 1);
