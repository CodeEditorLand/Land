...
export declare class ParcelWatcherInstance extends Disposable {
    ...
    constructor(ready: Promise<unknown>, request: IRecursiveWatchRequest, restarts: number, token: CancellationToken, worker: RunOnceWorker<IFileChange>, stopFn: () => Promise<void>);
