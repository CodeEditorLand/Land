...
let BaseSecretStorageService = class BaseSecretStorageService extends Disposable {
    ...
    get(key) {
        return this._sequencer.queue(key, async () => {
            ...
            const encrypted = storageService.get(fullKey, -1);
            if (!encrypted) {
    ...
    set(key, value) {
        return this._sequencer.queue(key, async () => {
            ...
            storageService.store(fullKey, encrypted, -1, 1);
    ...
    delete(key) {
        return this._sequencer.queue(key, async () => {
            ...
            storageService.remove(fullKey, -1);
    ...
    async initialize() {
        ...
        this._onDidChangeValueDisposable.add(storageService.onDidChangeValue(-1, undefined, this._onDidChangeValueDisposable)(e => {
