...
export class MouseHandler extends ViewEventHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._height = this._context.configuration.options.get(149 /* EditorOption.layoutInfo */).height;
    ...
    _setupMouseWheelZoomListener() {
        ...
        const onMouseWheel = (browserEvent) => {
            ...
            if (!this._context.configuration.options.get(78 /* EditorOption.mouseWheelZoom */)) {
                return;
            }
    ...
    onConfigurationChanged(e) {
        if (e.hasChanged(149 /* EditorOption.layoutInfo */)) {
            // layout change
            const height = this._context.configuration.options.get(149 /* EditorOption.layoutInfo */).height;
    ...
    _onMouseDown(e, pointerId) {
        ...
        const selectOnLineNumbers = this._context.configuration.options.get(113 /* EditorOption.selectOnLineNumbers */);
...
class MouseDownOperation extends Disposable {
    ...
    start(targetType, e, pointerId) {
        ...
        if (!options.get(95 /* EditorOption.readOnly */)
...
class TopBottomDragScrollingOperation extends Disposable {
     ...
     */
    _getScrollSpeed() {
        const lineHeight = this._context.configuration.options.get(69 /* EditorOption.lineHeight */);
        const viewportInLines = this._context.configuration.options.get(149 /* EditorOption.layoutInfo */).height / lineHeight;
    ...
    _execute() {
        ...
        let mouseTarget;
        {
            ...
            const horizontalScrollbarHeight = this._context.configuration.options.get(149 /* EditorOption.layoutInfo */).horizontalScrollbarHeight;
