...
let TextAreaEditContext = class TextAreaEditContext extends AbstractEditContext {
    constructor(context, overflowGuardContainer, viewController, visibleRangeProvider, _keybindingService, _instantiationService) {
        ...
        this.textArea.setAttribute('tabindex', String(options.get(128 /* EditorOption.tabIndex */)));
        this.textArea.setAttribute('role', 'textbox');
        this.textArea.setAttribute('aria-roledescription', nls.localize('editor', "editor"));
        this.textArea.setAttribute('aria-multiline', 'true');
        this.textArea.setAttribute('aria-autocomplete', options.get(95 /* EditorOption.readOnly */) ? 'none' : 'both');
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.viewModel.getLineContent(position.lineNumber);
        const wordSeparators = getMapForWordSeparators(this._context.configuration.options.get(135 /* EditorOption.wordSeparators */), []);
    ...
    onConfigurationChanged(e) {
        ...
        this.textArea.setAttribute('aria-required', options.get(5 /* EditorOption.ariaRequired */) ? 'true' : 'false');
        this.textArea.setAttribute('tabindex', String(options.get(128 /* EditorOption.tabIndex */)));
        if (e.hasChanged(34 /* EditorOption.domReadOnly */) || e.hasChanged(95 /* EditorOption.readOnly */)) {
            this._ensureReadOnlyAttribute();
        }
    ...
    _ensureReadOnlyAttribute() {
        ...
        const useReadOnly = !IME.enabled || (options.get(34 /* EditorOption.domReadOnly */) && options.get(95 /* EditorOption.readOnly */));
        if (useReadOnly) {
    ...
    _doRender(renderData) {
        ...
        if (options.get(59 /* EditorOption.glyphMargin */)) {
            ...
            if (options.get(70 /* EditorOption.lineNumbers */).renderType !== 0 /* RenderLineNumbersType.Off */) {
