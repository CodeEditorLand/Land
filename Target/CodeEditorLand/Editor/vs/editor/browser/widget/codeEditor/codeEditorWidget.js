...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        const isDropIntoEnabled = () => {
            return !this._configuration.options.get(94)
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(134), this._configuration.options.get(133), position);
    }
    ...
    pushUndoStop() {
        ...
        if (this._configuration.options.get(94)) {
            return false;
        }
    ...
    applyFontInfo(target) {
        applyFontInfo(target, this._configuration.options.get(52));
    }
            ...
            switch (e.kind) {
                ...
                case 6: {
                    if (e.reachedMaxCursorCount) {
                        const multiCursorLimit = this.getOption(82);
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorReadonly.set(options.get(94));
        this._inDiffEditor.set(options.get(63));
