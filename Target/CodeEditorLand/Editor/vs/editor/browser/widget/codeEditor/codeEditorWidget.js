...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        const isDropIntoEnabled = () => {
            return !this._configuration.options.get(95 /* EditorOption.readOnly */)
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(135 /* EditorOption.wordSeparators */), this._configuration.options.get(134 /* EditorOption.wordSegmenterLocales */), position);
    }
    ...
    pushUndoStop() {
        ...
        if (this._configuration.options.get(95 /* EditorOption.readOnly */)) {
    ...
    getScrolledVisiblePosition(rawPosition) {
        ...
        return {
            top: top,
            left: left,
            height: options.get(69 /* EditorOption.lineHeight */)
        };
    }
            ...
            switch (e.kind) {
                ...
                case 6 /* OutgoingViewModelEventKind.CursorStateChanged */: {
                    if (e.reachedMaxCursorCount) {
                        const multiCursorLimit = this.getOption(82 /* EditorOption.multiCursorLimit */);
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorReadonly.set(options.get(95 /* EditorOption.readOnly */));
