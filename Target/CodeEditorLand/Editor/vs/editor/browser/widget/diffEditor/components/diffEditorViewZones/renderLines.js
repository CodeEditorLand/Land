...
export class RenderOptions {
    static fromEditor(editor) {
        ...
        const layoutInfo = modifiedEditorOptions.get(149 /* EditorOption.layoutInfo */);
        return new RenderOptions(editor.getModel()?.getOptions().tabSize || 0, fontInfo, modifiedEditorOptions.get(33 /* EditorOption.disableMonospaceOptimizations */), fontInfo.typicalHalfwidthCharacterWidth, modifiedEditorOptions.get(108 /* EditorOption.scrollBeyondLastColumn */), modifiedEditorOptions.get(69 /* EditorOption.lineHeight */), layoutInfo.decorationsWidth, modifiedEditorOptions.get(121 /* EditorOption.stopRenderingLineAfter */), modifiedEditorOptions.get(103 /* EditorOption.renderWhitespace */), modifiedEditorOptions.get(98 /* EditorOption.renderControlCharacters */), modifiedEditorOptions.get(53 /* EditorOption.fontLigatures */));
    }
