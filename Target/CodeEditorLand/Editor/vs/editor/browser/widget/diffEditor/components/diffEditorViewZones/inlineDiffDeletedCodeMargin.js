...
export class InlineDiffDeletedCodeMargin extends Disposable {
    ...
    constructor(_getViewZoneId, _marginDomNode, _modifiedEditor, _diff, _editor, _viewLineCounts, _originalTextModel, _contextMenuService, _clipboardService) {
        ...
        const lineHeight = this._modifiedEditor.getOption(69 /* EditorOption.lineHeight */);
        ...
        const useShadowDOM = _modifiedEditor.getOption(131 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        const showContextMenu = (x, y) => {
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    const readOnly = _modifiedEditor.getOption(95 /* EditorOption.readOnly */);
                    if (!readOnly) {
