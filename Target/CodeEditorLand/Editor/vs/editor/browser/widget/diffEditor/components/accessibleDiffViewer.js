...
AccessibleDiffViewer = __decorate([
    ...
    __metadata("design:paramtypes", [HTMLElement, Object, Function, Object, Object, Object, Object, Object, Object])
...
let View = class View extends Disposable {
    ...
    _render(store) {
        ...
        const lineHeight = modifiedOptions.get(69 /* EditorOption.lineHeight */);
    ...
    _createRow(item, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts) {
        const originalLayoutInfo = originalOptions.get(149 /* EditorOption.layoutInfo */);
        const originalLineNumbersWidth = originalLayoutInfo.glyphMarginWidth + originalLayoutInfo.lineNumbersWidth;
        const modifiedLayoutInfo = modifiedOptions.get(149 /* EditorOption.layoutInfo */);
    ...
    _getLineHtml(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const r = renderViewLine2(new RenderLineInput((fontInfo.isMonospace && !options.get(33 /* EditorOption.disableMonospaceOptimizations */)), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(121 /* EditorOption.stopRenderingLineAfter */), options.get(103 /* EditorOption.renderWhitespace */), options.get(98 /* EditorOption.renderControlCharacters */), options.get(53 /* EditorOption.fontLigatures */) !== EditorFontLigatures.OFF, null));
        return r.html;
    }
};
View = __decorate([
    ...
    __metadata("design:paramtypes", [HTMLElement,
        ViewModel, Object, Object, Object, Object])
], View);
