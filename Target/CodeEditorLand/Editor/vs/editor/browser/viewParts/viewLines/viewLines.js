...
export class ViewLines extends ViewPart {
    ...
    constructor(context, linesContent) {
        ...
        this._revealHorizontalRightPadding = options.get(104 /* EditorOption.revealHorizontalRightPadding */);
        ...
        this._stickyScrollEnabled = options.get(119 /* EditorOption.stickyScroll */).enabled;
        this._maxNumberStickyLines = options.get(119 /* EditorOption.stickyScroll */).maxLineCount;
    }
    dispose() {
    ...
    onConfigurationChanged(e) {
        ...
        if (e.hasChanged(150 /* EditorOption.wrappingInfo */)) {
            this._maxLineWidth = 0;
        }
        const options = this._context.configuration.options;
        const fontInfo = options.get(52 /* EditorOption.fontInfo */);
    ...
    _computeScrollLeftToReveal(horizontalRevealRequest) {
        ...
        const layoutInfo = this._context.configuration.options.get(149 /* EditorOption.layoutInfo */);
