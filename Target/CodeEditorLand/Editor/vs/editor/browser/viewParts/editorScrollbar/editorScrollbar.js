...
export class EditorScrollbar extends ViewPart {
    constructor(context, linesContent, viewDomNode, overflowGuardDomNode) {
        ...
        const mouseWheelScrollSensitivity = options.get(77 /* EditorOption.mouseWheelScrollSensitivity */);
        const fastScrollSensitivity = options.get(42 /* EditorOption.fastScrollSensitivity */);
        const scrollPredominantAxis = options.get(110 /* EditorOption.scrollPredominantAxis */);
    ...
    onConfigurationChanged(e) {
        if (e.hasChanged(107 /* EditorOption.scrollbar */)
            || e.hasChanged(77 /* EditorOption.mouseWheelScrollSensitivity */)
