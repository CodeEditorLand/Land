...
export class OverviewRuler extends ViewEventHandler {
    constructor(context, cssClassName) {
        ...
        this._zoneManager.setLineHeight(options.get(69 /* EditorOption.lineHeight */));
        this._zoneManager.setPixelRatio(options.get(147 /* EditorOption.pixelRatio */));
    ...
    onConfigurationChanged(e) {
        ...
        if (e.hasChanged(147 /* EditorOption.pixelRatio */)) {
            this._zoneManager.setPixelRatio(options.get(147 /* EditorOption.pixelRatio */));
