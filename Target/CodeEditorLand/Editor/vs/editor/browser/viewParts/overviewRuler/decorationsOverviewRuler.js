...
class Settings {
    constructor(config, theme) {
        ...
        this.pixelRatio = options.get(147 /* EditorOption.pixelRatio */);
        this.overviewRulerLanes = options.get(86 /* EditorOption.overviewRulerLanes */);
        this.renderBorder = options.get(85 /* EditorOption.overviewRulerBorder */);
