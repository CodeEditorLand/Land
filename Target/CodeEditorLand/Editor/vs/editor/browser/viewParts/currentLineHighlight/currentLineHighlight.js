...
export class AbstractLineHighlightOverlay extends DynamicViewOverlay {
    constructor(context) {
        ...
        this._renderLineHighlight = options.get(100 /* EditorOption.renderLineHighlight */);
        this._renderLineHighlightOnlyWhenFocus = options.get(101 /* EditorOption.renderLineHighlightOnlyWhenFocus */);
