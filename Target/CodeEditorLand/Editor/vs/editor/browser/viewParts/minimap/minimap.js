...
class MinimapOptions {
    constructor(configuration, theme, tokensColorTracker) {
        ...
        const pixelRatio = options.get(147 /* EditorOption.pixelRatio */);
        const layoutInfo = options.get(149 /* EditorOption.layoutInfo */);
        const minimapLayout = layoutInfo.minimap;
        const fontInfo = options.get(52 /* EditorOption.fontInfo */);
        const minimapOpts = options.get(75 /* EditorOption.minimap */);
        this.renderMinimap = minimapLayout.renderMinimap;
        this.size = minimapOpts.size;
        this.minimapHeightIsEditorHeight = minimapLayout.minimapHeightIsEditorHeight;
        this.scrollBeyondLastLine = options.get(109 /* EditorOption.scrollBeyondLastLine */);
        this.paddingTop = options.get(87 /* EditorOption.padding */).top;
        this.paddingBottom = options.get(87 /* EditorOption.padding */).bottom;
