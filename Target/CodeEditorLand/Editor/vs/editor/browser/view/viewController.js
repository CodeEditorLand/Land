...
export class ViewController {
    ...
    _hasMulticursorModifier(data) {
        switch (this.configuration.options.get(80 /* EditorOption.multiCursorModifier */)) {
            case 'altKey':
                return data.altKey;
            case 'ctrlKey':
                return data.ctrlKey;
    ...
    dispatchMouse(data) {
        ...
        const selectionClipboardIsOn = (platform.isLinux && options.get(111 /* EditorOption.selectionClipboard */));
