...
export class ViewModel extends Disposable {
    constructor(editorId, configuration, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, scheduleAtNextAnimationFrame, languageConfigurationService, _themeService, _attachedView, _transactionalTarget) {
        ...
        if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
            ...
            const wrappingStrategy = options.get(143 /* EditorOption.wrappingStrategy */);
            const wrappingInfo = options.get(150 /* EditorOption.wrappingInfo */);
            const wrappingIndent = options.get(142 /* EditorOption.wrappingIndent */);
            const wordBreak = options.get(133 /* EditorOption.wordBreak */);
    ...
    _onConfigurationChanged(eventsCollector, e) {
        ...
        if (e.hasChanged(102 /* EditorOption.renderValidationDecorations */)) {
            this._decorations.reset();
            eventsCollector.emitViewEvent(new viewEvents.ViewDecorationsChangedEvent(null));
        }
    ...
    */
    ...
    getVisibleRangesPlusViewportAboveBelow() {
        const layoutInfo = this._configuration.options.get(149 /* EditorOption.layoutInfo */);
        const lineHeight = this._configuration.options.get(69 /* EditorOption.lineHeight */);
