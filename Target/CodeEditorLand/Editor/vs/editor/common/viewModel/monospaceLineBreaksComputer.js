...
export class MonospaceLineBreaksComputerFactory {
    static create(options) {
        return new MonospaceLineBreaksComputerFactory(options.get(138 /* EditorOption.wordWrapBreakBeforeCharacters */), options.get(137 /* EditorOption.wordWrapBreakAfterCharacters */));
    }
