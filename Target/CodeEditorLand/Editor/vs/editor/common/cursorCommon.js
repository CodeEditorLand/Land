...
export class CursorConfiguration {
    static shouldRecreate(e) {
        return (e.hasChanged(149 /* EditorOption.layoutInfo */)
            || e.hasChanged(135 /* EditorOption.wordSeparators */)
            || e.hasChanged(38 /* EditorOption.emptySelectionClipboard */)
            || e.hasChanged(79 /* EditorOption.multiCursorMergeOverlapping */)
            || e.hasChanged(81 /* EditorOption.multiCursorPaste */)
            || e.hasChanged(82 /* EditorOption.multiCursorLimit */)
            ...
            || e.hasChanged(132 /* EditorOption.useTabStops */)
            || e.hasChanged(52 /* EditorOption.fontInfo */)
            || e.hasChanged(95 /* EditorOption.readOnly */)
            || e.hasChanged(134 /* EditorOption.wordSegmenterLocales */));
    }
    constructor(languageId, modelOptions, configuration, languageConfigurationService) {
        ...
        this.readOnly = options.get(95 /* EditorOption.readOnly */);
        this.tabSize = modelOptions.tabSize;
        this.indentSize = modelOptions.indentSize;
        this.insertSpaces = modelOptions.insertSpaces;
        this.stickyTabStops = options.get(120 /* EditorOption.stickyTabStops */);
        this.lineHeight = fontInfo.lineHeight;
        this.typicalHalfwidthCharacterWidth = fontInfo.typicalHalfwidthCharacterWidth;
        this.pageSize = Math.max(1, Math.floor(layoutInfo.height / this.lineHeight) - 2);
        this.useTabStops = options.get(132 /* EditorOption.useTabStops */);
        this.wordSeparators = options.get(135 /* EditorOption.wordSeparators */);
        ...
        this.multiCursorMergeOverlapping = options.get(79 /* EditorOption.multiCursorMergeOverlapping */);
        this.multiCursorPaste = options.get(81 /* EditorOption.multiCursorPaste */);
        this.multiCursorLimit = options.get(82 /* EditorOption.multiCursorLimit */);
        ...
        this.wordSegmenterLocales = options.get(134 /* EditorOption.wordSegmenterLocales */);
