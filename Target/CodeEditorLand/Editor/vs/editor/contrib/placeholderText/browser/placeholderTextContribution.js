...
export class PlaceholderTextContribution extends Disposable {
    ...
    constructor(_editor) {
        ...
        this._placeholderText = this._editorObs.getOption(91 /* EditorOption.placeholder */);
        ...
        this._view = derivedWithStore((reader, store) => {
            ...
            store.add(autorun(reader => {
                ...
                element.root.style.lineHeight = this._editorObs.getOption(69 /* EditorOption.lineHeight */).read(reader) + 'px';
            }));
