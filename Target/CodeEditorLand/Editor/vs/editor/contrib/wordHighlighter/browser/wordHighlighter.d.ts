...
declare class WordHighlighter {
    ...
    constructor(editor: IActiveCodeEditor, providers: LanguageFeatureRegistry<DocumentHighlightProvider>, multiProviders: LanguageFeatureRegistry<MultiDocumentHighlightProvider>, contextKeyService: IContextKeyService, textModelService: ITextModelService, codeEditorService: ICodeEditorService);
...
export declare class WordHighlighterContribution extends Disposable implements IEditorContribution {
    ...
    constructor(editor: ICodeEditor, contextKeyService: IContextKeyService, languageFeaturesService: ILanguageFeaturesService, codeEditorService: ICodeEditorService, textModelService: ITextModelService);
