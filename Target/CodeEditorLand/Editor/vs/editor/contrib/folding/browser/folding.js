...
let FoldingController = class FoldingController extends Disposable {
    ...
    constructor(editor, contextKeyService, languageConfigurationService, notificationService, languageFeatureDebounceService, languageFeaturesService) {
        ...
        this._isEnabled = options.get(45);
        this._useFoldingProviders = options.get(46) !== 'indentation';
        this._unfoldOnClickAfterEndOfLine = options.get(50);
        this._restoringViewState = false;
        this._currentModelHasFoldedImports = false;
        this._foldingImportsByDefault = options.get(48);
        ...
        this.foldingDecorationProvider.showFoldingControls = options.get(113);
        this.foldingDecorationProvider.showFoldingHighlights = options.get(47);
        ...
        this._register(this.editor.onDidChangeConfiguration((e) => {
            ...
            if (e.hasChanged(113) || e.hasChanged(47)) {
                const options = this.editor.getOptions();
                this.foldingDecorationProvider.showFoldingControls = options.get(113);
                this.foldingDecorationProvider.showFoldingHighlights = options.get(47);
...
class ToggleFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048 | 41, 2048 | 1024 | 42),
                weight: 100
            }
        });
    }
