...
let CopyPasteController = class CopyPasteController extends Disposable {
    ...
    isPasteAsEnabled() {
        return this._editor.getOption(88 /* EditorOption.pasteAs */).enabled;
    }
    async finishedPaste() {
    ...
    async handlePaste(e) {
        ...
        if (this._editor.getOption(95 /* EditorOption.readOnly */) // Never enabled if editor is readonly.
        ...
        const p = createCancelablePromise(async (pToken) => {
            ...
            try {
                ...
                if (editSession.edits.length) {
                    const canShowWidget = editor.getOption(88 /* EditorOption.pasteAs */).showPasteSelector === 'afterPaste';
