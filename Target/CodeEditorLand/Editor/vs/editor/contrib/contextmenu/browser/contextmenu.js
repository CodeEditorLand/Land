...
let ContextMenuController = class ContextMenuController {
    ...
    _doShowContextMenu(actions, event = null) {
        ...
        const useShadowDOM = this._editor.getOption(131 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        // Show menu
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        const minimapOptions = this._editor.getOption(75 /* EditorOption.minimap */);
        let lastId = 0;
