...
export class ClickLinkGesture extends Disposable {
    constructor(editor, opts) {
        ...
        this._opts = createOptions(this._editor.getOption(80 /* EditorOption.multiCursorModifier */));
        this._lastMouseMoveEvent = null;
        this._hasTriggerKeyOnMouseDown = false;
        this._lineNumberOnMouseDown = 0;
        this._register(this._editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(80 /* EditorOption.multiCursorModifier */)) {
                const newOpts = createOptions(this._editor.getOption(80 /* EditorOption.multiCursorModifier */));
