...
let ColorDetector = class ColorDetector extends Disposable {
    ...
    constructor(_editor, _configurationService, _languageFeaturesService, languageFeatureDebounceService) {
        ...
        this._register(_editor.onDidChangeConfiguration((e) => {
            ...
            this._isColorDecoratorsEnabled = this.isEnabled();
            this._isDefaultColorDecoratorsEnabled = this._editor.getOption(151 /* EditorOption.defaultColorDecorators */);
            ...
            const updatedDefaultColorDecoratorsSetting = e.hasChanged(151 /* EditorOption.defaultColorDecorators */);
