...
let StandaloneColorPickerParticipant = class StandaloneColorPickerParticipant {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        if (context.setMinimumDimensions) {
            const minimumHeight = this._editor.getOption(69 /* EditorOption.lineHeight */) + 8;
        ...
        const colorPicker = disposables.add(new ColorPickerWidget(context.fragment, model, this._editor.getOption(147 /* EditorOption.pixelRatio */), this._themeService, true));
