...
export class MultiCursorSession {
    ...
    _getNextMatch() {
        ...
        const nextMatch = this._editor.getModel().findNextMatch(this.searchText, lastAddedSelection.getEndPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false);
        if (!nextMatch) {
            return null;
        }
    ...
    _getPreviousMatch() {
        ...
        const allSelections = this._editor.getSelections();
        const lastAddedSelection = allSelections[allSelections.length - 1];
        const previousMatch = this._editor.getModel().findPreviousMatch(this.searchText, lastAddedSelection.getStartPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false);
        if (!previousMatch) {
            return null;
        }
    ...
    selectAll(searchScope) {
        ...
        if (searchScope) {
            return editorModel.findMatches(this.searchText, searchScope, false, this.matchCase, this.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */);
        }
        return editorModel.findMatches(this.searchText, true, false, this.matchCase, this.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */);
    }
}
    ...
    selectAll(findController) {
        ...
        if (findState.isRevealed && findState.searchString.length > 0 && findState.isRegex) {
            ...
            if (findState.searchScope) {
                matches = editorModel.findMatches(findState.searchString, findState.searchScope, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */);
            }
            else {
                matches = editorModel.findMatches(findState.searchString, true, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(135 /* EditorOption.wordSeparators */) : null, false, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */);
            }
        }
        else {
            this._beginSessionIfNeeded(findController);
...
let SelectionHighlighter = class SelectionHighlighter extends Disposable {
    ...
    constructor(editor, _languageFeaturesService) {
        ...
        this.editor = editor;
        this._isEnabled = editor.getOption(112 /* EditorOption.selectionHighlight */);
    ...
    static _createState(oldState, isEnabled, editor) {
        ...
        return new SelectionHighlighterState(editor.getModel(), r.searchText, r.matchCase, r.wholeWord ? editor.getOption(135 /* EditorOption.wordSeparators */) : null, oldState);
    }
    _setState(newState) {
        this.state = newState;
        if (!this.state) {
        ...
        const occurrenceHighlighting = this.editor.getOption(83 /* EditorOption.occurrencesHighlight */) !== 'off';
