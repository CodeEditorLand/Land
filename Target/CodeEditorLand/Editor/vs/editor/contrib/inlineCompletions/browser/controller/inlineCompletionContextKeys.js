...
export class InlineCompletionContextKeys extends Disposable {
    ...
    constructor(contextKeyService, model) {
        ...
        this._register(bindContextKey(InlineCompletionContextKeys.inlineEditVisible, this.contextKeyService, reader => this.model.read(reader)?.stateInlineEdit.read(reader) !== undefined));
