...
let ContentHoverController = class ContentHoverController extends Disposable {
    ...
    _hookListeners() {
        const hoverOpts = this._editor.getOption(62);
        this._hoverSettings = {
    ...
    _reactToEditorMouseMove(mouseEvent) {
        ...
        const decoratorActivatedOn = this._editor.getOption(151);
    ...
    _onKeyDown(e) {
        ...
        const shouldKeepHoverVisible = (resolvedKeyboardEvent.kind === 1 ||
            (resolvedKeyboardEvent.kind === 2
