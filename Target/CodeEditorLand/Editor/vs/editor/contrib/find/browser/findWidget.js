...
export class FindWidget extends Widget {
    ...
    constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService, _hoverService) {
        ...
        this._register(this._codeEditor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(94)) {
                if (this._codeEditor.getOption(94)) {
            ...
            if (e.hasChanged(43)) {
                const supportLoop = this._codeEditor.getOption(43).loop;
                this._state.change({ loop: supportLoop }, false);
                const addExtraSpaceOnTop = this._codeEditor.getOption(43).addExtraSpaceOnTop;
    ...
    _onStateChanged(e) {
        ...
        if (e.isReplaceRevealed) {
            if (this._state.isReplaceRevealed) {
                if (!this._codeEditor.getOption(94) && !this._isReplaceVisible) {
    ...
    _updateButtons() {
        ...
        const canReplace = !this._codeEditor.getOption(94);
    ...
    _reveal() {
        ...
        if (!this._isVisible) {
            ...
            if (this._codeEditor.getOption(43).seedSearchStringFromSelection && selection) {
    ...
    _showViewZone(adjustScroll = true) {
        ...
        this._codeEditor.changeViewZones((accessor) => {
            if (this._viewZoneId !== undefined) {
                ...
                scrollAdjustment -= this._codeEditor.getOption(86).top;
