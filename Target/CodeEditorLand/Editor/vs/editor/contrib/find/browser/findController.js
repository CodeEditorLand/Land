...
let CommonFindController = class CommonFindController extends Disposable {
    ...
    async getGlobalBufferTerm() {
        if (this._editor.getOption(43).globalFindClipboard
...
StartFindAction.addImplementation(0, (accessor, editor, args) => {
    ...
    return controller.start({
        forceRevealReplace: false,
        seedSearchStringFromSelection: editor.getOption(43).seedSearchStringFromSelection !== 'never' ? 'single' : 'none',
        seedSearchStringFromNonEmptySelection: editor.getOption(43).seedSearchStringFromSelection === 'selection',
        seedSearchStringFromGlobalClipboard: editor.getOption(43).globalFindClipboard,
        shouldFocus: 1,
        shouldAnimate: true,
        updateSearchScope: false,
        loop: editor.getOption(43).loop
    });
});
    ...
    async run(accessor, editor, args) {
        ...
        if (controller) {
            ...
            await controller.start({
                forceRevealReplace: false,
                seedSearchStringFromSelection: (controller.getState().searchString.length === 0) && editor.getOption(43).seedSearchStringFromSelection !== 'never' ? 'single' : 'none',
                seedSearchStringFromNonEmptySelection: editor.getOption(43).seedSearchStringFromSelection === 'selection',
...
StartFindReplaceAction.addImplementation(0, (accessor, editor, args) => {
    if (!editor.hasModel() || editor.getOption(94)) {
        return false;
    }
    const controller = CommonFindController.get(editor);
    if (!controller) {
    ...
    const seedSearchStringFromSelection = !currentSelection.isEmpty()
        ...
        && (editor.getOption(43).seedSearchStringFromSelection !== 'never')
        && !findInputFocused;
    ...
    return controller.start({
        ...
        seedSearchStringFromNonEmptySelection: editor.getOption(43).seedSearchStringFromSelection === 'selection',
        seedSearchStringFromGlobalClipboard: editor.getOption(43).seedSearchStringFromSelection !== 'never',
