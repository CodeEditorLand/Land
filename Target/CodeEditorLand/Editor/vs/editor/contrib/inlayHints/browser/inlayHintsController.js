...
let InlayHintsController = class InlayHintsController {
    ...
    constructor(_editor, _languageFeaturesService, _featureDebounce, _inlayHintsCache, _commandService, _notificationService, _instaService) {
        ...
        this._disposables.add(_editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(145 /* EditorOption.inlayHints */)) {
                this._update();
            }
        }));
        this._update();
    ...
    _update() {
        ...
        this._removeAllDecorations();
        const options = this._editor.getOption(145 /* EditorOption.inlayHints */);
    ...
    _updateHintsDecorators(ranges, items) {
        ...
        const maxLength = this._editor.getOption(145 /* EditorOption.inlayHints */).maximumLength;
