...
export class StickyScrollWidget extends Disposable {
    constructor(_editor) {
        ...
        this._lineHeight = this._editor.getOption(69 /* EditorOption.lineHeight */);
        ...
        const updateScrollLeftPosition = () => {
            this._linesDomNode.style.left = this._editor.getOption(119 /* EditorOption.stickyScroll */).scrollWithEditor ? `-${this._editor.getScrollLeft()}px` : '0px';
        };
        this._register(this._editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(119 /* EditorOption.stickyScroll */)) {
    ...
    _setFoldingHoverListeners() {
        const showFoldingControls = this._editor.getOption(114 /* EditorOption.showFoldingControls */);
