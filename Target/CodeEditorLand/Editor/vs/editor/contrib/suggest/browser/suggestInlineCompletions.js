...
let SuggestInlineCompletions = class SuggestInlineCompletions extends Disposable {
    ...
    async provideInlineCompletions(model, position, context, token) {
        ...
        const config = editor.getOption(93 /* EditorOption.quickSuggestions */);
        ...
        if (!triggerCharacterInfo && this._lastResult?.canBeReused(model, position.lineNumber, wordInfo)) {
            ...
            const completionModel = new CompletionModel(completions.items, position.column, new LineContext(leadingLineContents, 0), WordDistance.None, editor.getOption(122 /* EditorOption.suggest */), editor.getOption(116 /* EditorOption.snippetSuggestions */), { boostFullMatch: false, firstMatchCanBeWeak: false }, clipboardText);
