...
let WordContextKey = class WordContextKey {
    ...
    constructor(_editor, contextKeyService) {
        ...
        this._configListener = this._editor.onDidChangeConfiguration(e => e.hasChanged(127 /* EditorOption.tabCompletion */) && this._update());
        this._update();
    }
    dispose() {
    ...
    _update() {
        ...
        const enabled = this._editor.getOption(127 /* EditorOption.tabCompletion */) === 'on';
