...
let SuggestModel = SuggestModel_1 = class SuggestModel {
    ...
    _updateTriggerCharacters() {
        ...
        if (this._editor.getOption(95 /* EditorOption.readOnly */)
            || !this._editor.hasModel()
            || !this._editor.getOption(125 /* EditorOption.suggestOnTriggerCharacters */)) {
            return;
        }
    ...
    _doTriggerQuickSuggest() {
        if (QuickSuggestionsOptions.isAllOff(this._editor.getOption(93 /* EditorOption.quickSuggestions */))) {
            // not enabled
            return;
        }
        if (this._editor.getOption(122 /* EditorOption.suggest */).snippetsPreventQuickSuggestions && SnippetController2.get(this._editor)?.isInSnippet()) {
        ...
        this._triggerQuickSuggest.cancelAndSet(() => {
            ...
            const config = this._editor.getOption(93 /* EditorOption.quickSuggestions */);
        ...
        }, this._editor.getOption(94 /* EditorOption.quickSuggestionsDelay */));
    }
    ...
    trigger(options) {
        ...
        const snippetSuggestions = this._editor.getOption(116 /* EditorOption.snippetSuggestions */);
        ...
        Promise.all([completions, wordDistance]).then(async ([completions, wordDistance]) => {
            ...
            const fuzzySearchOptions = {
                ...
                firstMatchCanBeWeak: !this._editor.getOption(122 /* EditorOption.suggest */).matchOnWordStartOnly
            };
            this._completionModel = new CompletionModel(completions.items, this._context.column, {
                leadingLineContent: ctx.leadingLineContent,
                characterCountDelta: ctx.column - this._context.column
            }, wordDistance, this._editor.getOption(122 /* EditorOption.suggest */), this._editor.getOption(116 /* EditorOption.snippetSuggestions */), fuzzySearchOptions, clipboardText);
    ...
    static createSuggestFilter(editor) {
        ...
        // snippet setting
        const snippetSuggestions = editor.getOption(116 /* EditorOption.snippetSuggestions */);
        if (snippetSuggestions === 'none') {
            result.add(27 /* CompletionItemKind.Snippet */);
        }
        // type setting
        const suggestOptions = editor.getOption(122 /* EditorOption.suggest */);
