...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    ...
    _configureFont() {
        ...
        const fontSize = options.get(123 /* EditorOption.suggestFontSize */) || fontInfo.fontSize;
        const lineHeight = options.get(124 /* EditorOption.suggestLineHeight */) || fontInfo.lineHeight;
    ...
    getLayoutInfo() {
        const lineHeight = this._editor.getOption(124 /* EditorOption.suggestLineHeight */) || this._editor.getOption(52 /* EditorOption.fontInfo */).lineHeight;
