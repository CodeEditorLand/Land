...
let SuggestWidget = class SuggestWidget {
    ...
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        const applyIconStyle = () => this.element.domNode.classList.toggle('no-icons', !this.editor.getOption(122 /* EditorOption.suggest */).showIcons);
        applyIconStyle();
        ...
        const applyStatusBarStyle = () => this.element.domNode.classList.toggle('with-status-bar', this.editor.getOption(122 /* EditorOption.suggest */).showStatusBar);
        applyStatusBarStyle();
        ...
        this._disposables.add(this.editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(122 /* EditorOption.suggest */)) {
                applyStatusBarStyle();
                applyIconStyle();
            }
            if (this._completionModel && (e.hasChanged(52 /* EditorOption.fontInfo */) || e.hasChanged(123 /* EditorOption.suggestFontSize */) || e.hasChanged(124 /* EditorOption.suggestLineHeight */))) {
    ...
    getLayoutInfo() {
        ...
        const itemHeight = clamp(this.editor.getOption(124 /* EditorOption.suggestLineHeight */) || fontInfo.lineHeight, 8, 1000);
        const statusBarHeight = !this.editor.getOption(122 /* EditorOption.suggest */).showStatusBar || this._state === 2 /* State.Empty */ || this._state === 1 /* State.Loading */ ? 0 : itemHeight;
