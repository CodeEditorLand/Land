...
let SuggestController = class SuggestController {
    ...
    constructor(editor, _memoryService, _commandService, _contextKeyService, _instantiationService, _logService, _telemetryService) {
        ...
        ctxInsertMode.set(editor.getOption(122 /* EditorOption.suggest */).insertMode);
        this._toDispose.add(this.model.onDidTrigger(() => ctxInsertMode.set(editor.getOption(122 /* EditorOption.suggest */).insertMode)));
        ...
        this._toDispose.add(this.model.onDidSuggest(e => {
            ...
            if (e.triggerOptions.auto) {
                ...
                const options = this.editor.getOption(122 /* EditorOption.suggest */);
    ...
    getOverwriteInfo(item, toggleMode) {
        ...
        let replace = this.editor.getOption(122 /* EditorOption.suggest */).insertMode === 'replace';
        if (toggleMode) {
            replace = !replace;
        }
