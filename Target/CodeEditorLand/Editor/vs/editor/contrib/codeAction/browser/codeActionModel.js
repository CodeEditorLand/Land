...
class CodeActionOracle extends Disposable {
    ...
    _getRangeOfSelectionUnlessWhitespaceEnclosed(trigger) {
        ...
        const enabled = this._editor.getOption(67 /* EditorOption.lightbulb */).enabled;
...
export class CodeActionModel extends Disposable {
    constructor(_editor, _registry, _markerService, contextKeyService, _progressService, _configurationService, _telemetryService) {
        ...
        this._register(this._editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(67 /* EditorOption.lightbulb */)) {
                this._update();
            }
        }));
        this._update();
    ...
    _update() {
        ...
        if (model
            ...
            && !this._editor.getOption(95 /* EditorOption.readOnly */)) {
