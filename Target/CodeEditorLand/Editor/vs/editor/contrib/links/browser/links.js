...
let LinkDetector = class LinkDetector extends Disposable {
    ...
    constructor(editor, openerService, notificationService, languageFeaturesService, languageFeatureDebounceService) {
        ...
        this._register(editor.onDidChangeConfiguration((e) => {
            if (!e.hasChanged(73 /* EditorOption.links */)) {
                return;
            }
    ...
    async computeLinksNow() {
        if (!this.editor.hasModel() || !this.editor.getOption(73 /* EditorOption.links */)) {
            return;
        }
    ...
    updateDecorations(links) {
        const useMetaKey = (this.editor.getOption(80 /* EditorOption.multiCursorModifier */) === 'altKey');
