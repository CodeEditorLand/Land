...
import { ObservablePromise, autorun, autorunWithStore, derived, derivedDisposable, observableSignalFromEvent } from '../../../../base/common/observable.js';
...
let InlineEditSideBySideContentWidget = class InlineEditSideBySideContentWidget extends Disposable {
    ...
    constructor(_editor, _position, _text, _shift, _diff, _instantiationService) {
        ...
        this._register(autorun(reader => {
            ...
            const height = this._editor.getOption(69 /* EditorOption.lineHeight */) * lines;
            if (width <= 0) {
                return;
            }
