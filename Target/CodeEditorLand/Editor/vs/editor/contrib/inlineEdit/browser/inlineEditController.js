...
let InlineEditController = class InlineEditController extends Disposable {
    ...
    constructor(editor, instantiationService, contextKeyService, languageFeaturesService, _commandService, _configurationService, _diffProviderFactoryService, _modelService) {
        ...
        this._inlineEditEnabled = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(65 /* EditorOption.inlineEdit */).enabled);
        this._enabled = derived(this, reader => this._inlineEditEnabled.read(reader) && !this._inlineCompletionInlineEdits.read(reader));
        this._fontFamily = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(65 /* EditorOption.inlineEdit */).fontFamily);
        ...
        this._register(autorun(async (reader) => {
            ...
            if (this._configurationService.getValue('editor.experimentalInlineEdit.keepOnBlur') || editor.getOption(65 /* EditorOption.inlineEdit */).keepOnBlur) {
                return;
            }
