...
#
# Usage:
#   bash Maintain/Release/Build.sh              # Default production profile
#   bash Maintain/Release/Build.sh --profile release  # Full release with signing
#   bash Maintain/Release/Build.sh --profile web      # Web-only release
#
# Available profiles:
